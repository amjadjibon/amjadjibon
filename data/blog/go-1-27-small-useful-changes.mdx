...
[Run the generic method example on the Go Playground](https://go.dev/play/p/gkEe9YP1gfM).
...
[Run the embedded struct example on the Go Playground](https://go.dev/play/p/Hvei1Y0bY9N).
...
[Run the UUID example on the Go Playground](https://go.dev/play/p/j4_MuP6XdaU).
...
[Run the ML-DSA example on the Go Playground](https://go.dev/play/p/dzVAeAhZBwD).
